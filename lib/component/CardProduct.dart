...
class CardProduk extends StatelessWidget {
          ...
          content: Column(
            ...
            children: [
              ListTile(
                ...
                onTap: () {
                  Navigator.of(context, rootNavigator: true).pop();
                  reportProduct('Penipuan / Produk tidak sesuai', product);
                },
              ),
              ListTile(
                ...
                onTap: () {
                  Navigator.of(context, rootNavigator: true).pop();
                  reportProduct('Foto tidak pantas', product);
                },
              ),
            ],
          ),
  ...
  Future<void> favProduct(ProductModel product, bool save) async {
    FavoritService _favoritService = FavoritService();
    if (save) {
      await _favoritService.addFavorit(userData!.uid, product.pid);
    } else {
      await _favoritService.deleteFavorit(userData!.uid, product.pid);
    }
  ...
  Future<void> reportProduct(text, ProductModel product) async {
    ...
    if (userData?.role == "admin") {
      ...
      await _reportService.addReport(userData!.uid, text, product.pid,);
    }
